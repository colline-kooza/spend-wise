      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="z-50 flex items-center gap-1">
            ...
            >
              <span className="flex h-6 w-6 items-center justify-center rounded bg-black text-xs text-white">
                d
              </span>
              dub
            </a>
          ...
          <div className="flex items-center gap-3">
            <button className="hidden px-2 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-black sm:block lg:block">
              Log in
            </button>
            <button className="px-2 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-black sm:hidden">
              Log in
            </button>
